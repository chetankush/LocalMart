...
export default function AllReviewsList({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 bg-gray-50 rounded-2xl mb-12">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-full transition-colors cursor-pointer ${
                  selectedRating === null
          ...
          <div>
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="w-4 h-4 text-green-600 border-gray-300 rounded-full focus:ring-green-500 cursor-pointer"
              />
            ...
            <h2 className="text-xl font-bold text-gray-900">
              ...
              {(selectedRating || showVerifiedOnly) && (
                <button
                  ...
                  className="ml-3 text-sm text-green-600 hover:text-green-700 font-normal cursor-pointer rounded-full px-3 py-1 hover:bg-green-50 transition-colors"
                >
                  Clear Filters
                </button>
              )}
                      ...
                      <div className="mb-3">
                        ...
                        {shouldTruncate && (
                          <button
                            ...
                            className="text-green-600 hover:text-green-700 text-sm font-medium mt-2 cursor-pointer rounded-full px-2 py-1 hover:bg-green-50 transition-colors"
                          >
