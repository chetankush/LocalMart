          ...
          <div className="flex gap-3 pt-6 border-t border-gray-200">
            ...
            {availableStatuses.length > 0 && (
              <button
                ...
                className="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
